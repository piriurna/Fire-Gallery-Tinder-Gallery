...
sealed class DialogType(
    ...
    class Info(
        ...
        icon: ImageVector? = null,
        dialogOptions: DialogOptions
    ) : DialogType(title = title, description = description, mainColor = InfoBlue, iconColor = InfoBlue, imageId = imageId, icon = Icons.Filled.Info, dialogOptions = dialogOptions)
}
